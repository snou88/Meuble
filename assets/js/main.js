/* ============================================
   ...
   Version moderne avec animations fluides
   ============================================ */
...
if (newsletterForm) {
    newsletterForm.addEventListener('submit', (e) => {
        ...
        if (email) {
            ...
            const oldMessage = newsletterForm.querySelector('.newsletter-success');
...
// Ajouter le style pour l'effet de vague
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Observer les éléments avec l'attribut data-aos
    document.querySelectorAll('[data-aos]').forEach(el => observer.observe(el));
    
    // Initialiser le suivi de la section active
    window.addEventListener('scroll', highlightNavOnScroll);
    
    // Initialiser le slider hero s'il existe
    if (document.querySelector('.hero-slider')) {
        initHeroSlider();
    }
    
    console.log('Ama Meuble - Site chargé avec succès');
});
// ============================================
// HERO SLIDER
// ============================================
